...
class User_Administration(apps.katello.KatelloPage):
    ...
    @property
    def users(self):
        return [User(mozwebqa=self._mozwebqa, \
...
class RolesTab(apps.katello.KatelloPage):
    ...
    def roles(self):
        ...
        """
        return [Roles(mozwebqa=self._mozwebqa, \
                      locators=self.locators, \
                      root_element=element) \
            for element in self.selenium.find_elements(*self.locators.role_list_locator)]
    ...
    def role_users(self):
        ...
        """
        return [RoleUsers(mozwebqa=self._mozwebqa, \
                     locators=self.locators, \
                     root_element=element) \
            for element in self.selenium.find_elements(*self.locators.role_user_list_locator)]
    ...
    def role_orgs(self):
        ...
        """
        return [RoleOrgs(mozwebqa=self._mozwebqa, \
                     locators=self.locators, \
                     root_element=element) \
            for element in self.selenium.find_elements(*self.locators.role_orgs_list_locator)]

class RoleOrgs(apps.katello.KatelloPage):
    """
...
class Roles(apps.katello.KatelloPage):
    """
...
class RoleUsers(apps.katello.KatelloPage):
    """
